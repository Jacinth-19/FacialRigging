...
| Emotion from audio | ✅ `audio/emotion_classifier.cpp` + `tools/train_emotion.cpp`; CREMA-D 7442 clips, speaker-disjoint 59% acc / 58.9% UAR (6 classes); auto preset in generate + live 3 s window; UI/CLI `--emotion auto`; 4 tests | Fear/sad and happy/anger confusions remain (arousal-driven); speaker adaptation is item 20 |
